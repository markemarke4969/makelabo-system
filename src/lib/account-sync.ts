// ============================================================
// メイン → 予備アカウント 同期コアロジック
// ============================================================
// BAN対策の一環として、予備アカウント (role='standby') を
// 常にメイン (role='main') と同じ設定状態に保つための同期処理。
//
// 同期対象:
...
//   - メインに無いものでも予備の既存は削除しない (安全優先)
//   - 予備 sequence に active enrollment が残っていたらその sequence はスキップ
